...
interface ModalEliminarZonaProps {
  isOpen: boolean;
  onClose: () => void;
...
const ModalEliminarZona: React.FC<ModalEliminarZonaProps> = ({
  isOpen,
  onClose,
  onConfirm,
  zona
            ...
            <div className="mb-4">
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4 mb-4">
                ...
                <div className="flex items-center space-x-4 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <span>Capacidad: {zona.capacidad_maxima}</span>
                  <span>Piso: {zona.piso_nombre}</span>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-300">
                ¿Estás seguro de que quieres eliminar esta zona? Se eliminarán también todas las mesas asociadas.
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none"
                  rows={3}
                  required
                  autoFocus
                />
...
export default ModalEliminarZona;
